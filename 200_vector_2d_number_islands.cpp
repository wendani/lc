                ...
                if (grid[i][j] == '1')
                {
                    ...
                    if (!islandCells.count(id))
                    {
                        ...
                        while (!unexploredIslandCells.empty())
                        {
                            ...
                            if (j - 1 >= 0 && grid[i][j - 1] == '1' && !islandCells.count(id - 1))
                            {
                                islandCells.emplace(id - 1);
                                unexploredIslandCells.push(id - 1);
                            }
                            if (j + 1 < columnLen && grid[i][j + 1] == '1' && !islandCells.count(id + 1))
                            {
                                islandCells.emplace(id + 1);
                                unexploredIslandCells.push(id + 1);
                            }
                            if (i - 1 >= 0 && grid[i - 1][j] == '1' && !islandCells.count(id - columnLen))
                            {
                                islandCells.emplace(id - columnLen);
                                unexploredIslandCells.push(id - columnLen);
                            }
                            if (i + 1 < rowLen && grid[i + 1][j] == '1' && !islandCells.count(id + columnLen))
                            {
                                islandCells.emplace(id + columnLen);
                                unexploredIslandCells.push(id + columnLen);
                            }
