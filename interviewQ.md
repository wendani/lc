...
construct
	...
	from preorder      +      postorder (undetermined left/right node)
verify
...
if a singly linked list has a circle (Microsoft)
reorder log files
most common word
...
best time to buy and sell stock 2: buy one and sell one share of the stock as many times as you like.
